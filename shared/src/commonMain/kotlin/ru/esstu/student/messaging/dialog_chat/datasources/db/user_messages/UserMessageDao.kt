...
interface UserMessageDao {
    ...
    suspend fun getUserMessageWithRelated(appUserId: String, dialogId: String): UserMessageWithRelatedNew? {
    ...
    suspend fun updateUserMessageWithRelated(message: UserMessageEntityTable, files: List<UserCachedFileTable>) {
