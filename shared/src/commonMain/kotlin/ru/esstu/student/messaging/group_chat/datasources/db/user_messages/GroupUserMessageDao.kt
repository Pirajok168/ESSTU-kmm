package ru.esstu.student.messaging.group_chat.datasources.db.user_messages
...
interface GroupUserMessageDao {
    ...
    suspend fun getUserMessageWithRelated(appUserId: String, dialogId: Long): GroupChatUserMessageWithRelated? {
    ...
    suspend fun updateUserMessageWithRelated(message: GroupChatUserMessage, files: List<GroupChatUserCachedFileEntity>) {
