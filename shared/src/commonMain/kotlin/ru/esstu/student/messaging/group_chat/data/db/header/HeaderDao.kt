...
import ru.esstu.student.messaging.group_chat.data.db.header.entities.ConversationWithParticipants
...
interface HeaderDao {
    ...
    suspend fun getConversationWithParticipants(
        id: Int,
        appUserId: String
    ...
    suspend fun setConversationWithParticipants(conversation: ConversationWithParticipants) {
        deleteConversation(
            conversation.conversation.id.toInt(),
            conversation.conversation.appUserId
        )
