...
class SupportsCacheDatabase(
    ...
    private val dbQueries = database.supportsQueries
    ...
    override suspend fun getDialogWithLastMessage(
        ...
        fun map(
            ...
            return SupportWithMessage(
                conversation = SuppotTable(
    ...
    // TODO: Мне не нравится как это работает, надо пересмотреть реализацию
